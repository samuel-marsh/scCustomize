...
```{r echo=FALSE, fig.height=1,fig.width=11}
PalettePlot(palette = JCO_Four()) + ggtitle("4 color palette from ggsci package.")
PalettePlot(palette = Dark2_Pal()) + ggtitle("8 color Dark2 palette from RColorBrewer package")
PalettePlot(palette = ColorBlind_Pal()) + ggtitle("8 color modified color blind safe palette")
```
