...
scCustomize provides the `Percent_Expressing` function^["Internals of this functions were adapted/modified from the internals of `Seurat::DotPlot`] to make this easy.
```{r eval=FALSE}
