...
***Samuel Marsh. (2021). samuel-marsh/scCustomize:***  
***Version 0.6.0 (v0.6.0). Zenodo.***  
...
- Please incude the code that you are running and the full text of the error message.
- If possible please include a reproducible example.  Ssuggest using [SeuratData package](https://github.com/satijalab/seurat-data) pbmc3k dataset for lightweight example.
...
### *Installation Issues*  
Please see [Installation](LINK) page for more detailed installation instructions.  If the issue persists please submit [GitHub issue](https://github.com/samuel-marsh/scCustomize/issues).
