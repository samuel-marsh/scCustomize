...
<img src="../man/figures/assets/Read10X_GEO.png" title="*Example outputs for GEX only (list of matrices) or multimodal (list of list of matrices) 10X-Style files downloaded from NCBI GEO*" alt="*Example outputs for GEX only (list of matrices) or multimodal (list of list of matrices) 10X-Style files downloaded from NCBI GEO*" width="49%" style="display: block; margin: auto;" /><img src="../man/figures/assets/multimodal.png" title="*Example outputs for GEX only (list of matrices) or multimodal (list of list of matrices) 10X-Style files downloaded from NCBI GEO*" alt="*Example outputs for GEX only (list of matrices) or multimodal (list of list of matrices) 10X-Style files downloaded from NCBI GEO*" width="49%" style="display: block; margin: auto;" />
...
<img src="../man/figures/assets/delim_default.png" title="*Example outputs with default naming based on file name or providing `sample_names` parameter.*" alt="*Example outputs with default naming based on file name or providing `sample_names` parameter.*" width="49%" style="display: block; margin: auto;" /><img src="../man/figures/assets/renamed.png" title="*Example outputs with default naming based on file name or providing `sample_names` parameter.*" alt="*Example outputs with default naming based on file name or providing `sample_names` parameter.*" width="49%" style="display: block; margin: auto;" />
...
```r
cell_bender <- Read10X_h5_Multi_Directory(base_path = "cellbender_results/", h5_filename = "_out_filtered.h5",
    cell_bender = TRUE, default_10X = FALSE, parallel = TRUE, num_cores = 8)
```
...
<img src="../man/figures/assets/geo_merged.png" title="*Progress bar outputs in `Merge_Sparse_Data_All` function through scCustomize.*" alt="*Progress bar outputs in `Merge_Sparse_Data_All` function through scCustomize.*" width="98%" style="display: block; margin: auto;" />
