...
scCustomize has two import dependency requirements that need to be updated if already installed (if not installed they will be automatically installed during scCustomize installation).
  
* [SeuratObject](https://cran.r-project.org/web/packages/SeuratObject/index.html) >= v4.0.3.  
...
See [NEWS](LINK) file for ChangeLog with additions, changes, and fixes contained in each release.
