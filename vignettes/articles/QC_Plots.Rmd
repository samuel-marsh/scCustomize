...
```{r}
median_stats <- Median_Stats(seurat_object = hca_bm, group.by = "orig.ident")
```
...
```{r eval=FALSE}
median_stats <- Median_Stats(seurat_object = hca_bm, group.by = "orig.ident", median_var = "meta_data_column_name")
```
...
p1 <- Plot_Median_Genes(seurat_object = hca_bm, group.by = "group")
p2 <- Plot_Median_UMIs(seurat_object = hca_bm, group.by = "group")
p3 <- Plot_Median_Mito(seurat_object = hca_bm, group.by = "group")
p4 <- Plot_Median_Other(seurat_object = hca_bm, median_var = "percent_ribo", group.by = "group")
...
Plot_Cells_per_Sample(seurat_object = marsh_mouse_micro, group.by = "Transcription_Method")
```
