...
PalettePlot(pal = NavyAndOrange()) + ggtitle("NavyAndOrange() (2 colors)")
PalettePlot(pal = DiscretePalette_scCustomize(num_colors = 36, palette = "polychrome")) + ggtitle("polychrome (36 colors)")
PalettePlot(pal = DiscretePalette_scCustomize(num_colors = 50, palette = "varibow", shuffle_pal = TRUE)) + ggtitle("varibow (50 color version)")
```
