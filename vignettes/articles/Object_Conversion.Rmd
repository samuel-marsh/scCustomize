...
scCustomize contains modified version of this function which extends the Seurat function [`as.Seurat()`](`as.Seurat.liger()`) that solves these issues with some extra parameters:   
