...
```{r message=TRUE}
new_seurat <- Liger_to_Seurat(liger_object = pbmc_liger, reduction_label = "UMAP")
```
...
The release of Seurat V5+ has brought about two different types of assay structure that can exist within a Seurat object.  
