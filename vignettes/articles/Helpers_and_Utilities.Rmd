...
## Meta Data  
scCustomize contains a set of functions to add in use of meta data both within and outside of objects.  
...
#### Merge with sample-level summary statisic data  
...
* Sample-level meta data/file.  Can be either a data.frame or tibble in environemnt or a path to file to read.  
