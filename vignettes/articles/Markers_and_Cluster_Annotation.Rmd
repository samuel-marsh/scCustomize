...
top_5 <- Extract_Top_Markers(marker_dataframe = all_markers, num_features = 5, rank_by = "avg_log2FC")
head(top_5, 10) 
```

### Return data.frame (Optional)
```{r eval=FALSE}
top_5_df <- Extract_Top_Markers(marker_dataframe = all_markers, num_features = 5, data_frame = TRUE, rank_by = "avg_log2FC")
...
presto_markers <- qs_read("assets/presto_markers.qs2")

# Extract top markers
top_5_presto <- Extract_Top_Markers(marker_dataframe = presto_markers, num_features = 5, group.by = "cluster", rank_by = "auc", gene_column = "gene")
...
```{r}
# Default parameters
top_5 <- Extract_Top_Markers(marker_dataframe = all_markers, num_features = 5, rank_by = "avg_log2FC", named_vector = FALSE)

any(duplicated(x = top_5))

# Set `make_unique = TRUE`
top_5_unique <- Extract_Top_Markers(marker_dataframe = all_markers, num_features = 5, rank_by = "avg_log2FC", named_vector = FALSE, make_unique = TRUE)
