...
<center>
<img src="../reference/figures/assets/Read10X_GEO.png" width=49%> <img src="../reference/figures/assets/multimodal.png" width=49%>
*Example outputs for GEX only (list of matrices) or multimodal (list of list of matrices) 10X-Style files downloaded from NCBI GEO*
<center>
...
<center>
<img src="../reference/figures/assets/delim_default.png" width=49%> <img src="../reference/figures/assets/renamed.png" width=49%>
...
<center>
<img src="../reference/figures/assets/geo_merged.png" width=98%>
*Progress bar outputs in `Merge_Sparse_Data_All` function through scCustomize.*
<center>
