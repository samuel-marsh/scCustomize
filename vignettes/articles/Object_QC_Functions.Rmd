...
obj <- Add_Cell_QC_Metrics(object = obj, species = "Human", ensembl_ids = TRUE)
```
...
```{r eval=FALSE}
# Using gene name patterns
pbmc <- Add_Cell_QC_Metrics(object = pbmc, species = "other", mito_pattern = "regexp_pattern_mito", ribo_pattern = "regexp_pattern_ribo")
...
```{r include=FALSE}
pbmc_dual_species <- qs_read("assets/pbmc_dual_species.qs2")
```
