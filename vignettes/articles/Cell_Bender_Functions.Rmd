...
astrocytes_cortex <- qs_read("assets/astro_nuc_seq.qs2")
```
...
```{r eval=FALSE}
median_stats <- Median_Stats(seurat_object = dual_seurat, group.by = "orig.ident", median_var = c("nCount_Diff", "nFeature_Diff"))
```
