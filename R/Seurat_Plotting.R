...
#' @param row_km_repeats \code{lifecycle::badge("deprecated")} soft-deprecated.  See `feature_km_repeats`
...
#' @param column_km_repeats \code{lifecycle::badge("deprecated")} soft-deprecated.  See `ident_km_repeats`
